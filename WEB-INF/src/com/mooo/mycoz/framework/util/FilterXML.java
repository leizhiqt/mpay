...
public class FilterXML {
	...
	public synchronized static String encodingAmpsand(String input) {
	...
	public synchronized static String encodingLT(String input) {
		if (input == null || input.indexOf("<") < 0) {
			return input;
		} else {
			int index;
	...
	public synchronized static String encodingGT(String input) {
		if (input == null || input.indexOf(">") < 0) {
			return input;
		} else {
			int index;
	...
	public synchronized static String encodingAmpsands(String input) {// add by gchen at
															// 07,07,25
