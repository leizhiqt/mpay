...
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="BrewCrafts"/></caption>

<tbody>

<tr>
<td class="tl"><fmt:message key="CraftsName"/></td>
<td><input type="text" name="brewCrafts.craftsName" maxlength="32" style="width:120px;"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="CraftsDesc"/></td>
<td><input type="text" name="brewCrafts.craftsDesc" maxlength="64" style="width:120px;" /></td>
</tr>
