...
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="BrewJob"/></caption>
...
<td><input type="text" name="brewJob.brewNumber" maxlength="20" style="width:120px;"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Quantity"/></td>
<td><input type="text" name="brewJob.quantity" maxlength="7" style="width:120px;" /><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Unit"/></td>
<td><input type="text" name="brewJob.unit" maxlength="4" style="width:120px;" /><font class="fm">*</font></td>
</tr>
