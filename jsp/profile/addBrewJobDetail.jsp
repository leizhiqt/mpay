...
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="BrewJobDetail"/></caption>
...
<td><input type="text" name="brewJobDetail.jobPeople" maxlength="32" style="width:120px;"/><font class="fm">*</font></td>
</tr>
