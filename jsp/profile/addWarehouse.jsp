...
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="Warehouse"/></caption>
...
<td><input type="text" name="warehouse.warehouseName"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Contact"/></td>
<td><input type="text" name="warehouse.contact"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Address"/></td>
<td><input type="text" name="warehouse.address" size="32" maxlength="32"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Zipcode"/></td>
<td><input type="text" name="warehouse.zipcode" size="6" maxlength="6"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Telephone"/></td>
<td><input type="text" name="warehouse.telephone" size="15" maxlength="15"/><font class="fm">*</font></td>
</tr>
