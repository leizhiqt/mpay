...
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="Branch"/></caption>
...
<td><input type="text" name="branch.abbreviation" size="5" maxlength="5"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Definition"/></td>
<td><input type="text" name="branch.definition"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Address"/></td>
<td><input type="text" name="branch.address" size="44"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Telephone"/></td>
<td><input type="text" name="branch.phone" size="12" maxlength="12"/><font class="fm">*</font></td>
</tr>
