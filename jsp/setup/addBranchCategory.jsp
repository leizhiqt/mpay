...
<td>
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="BranchCategory"/></caption>

<tbody>
<tr>
<td class="tl"><fmt:message key="Abbreviation"/></td>
<td><input type="text" name="branchCategory.abbreviation" size="10" maxlength="10"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Definition"/></td>
<td><input type="text" name="branchCategory.definition"/><font class="fm">*</font></td>
</tr>
</tbody>
