...
<td><input type="text" name="userType.abbreviation" size="5" maxlength="5"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Definition"/></td>
<td><input type="text" name="userType.definition"/><font class="fm">*</font></td>
</tr>
