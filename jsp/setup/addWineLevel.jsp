...
<td>
<table class="modify">
<caption><fmt:message key="Add"/> <fmt:message key="WineLevel"/></caption>

<tbody>
<tr>
<td class="tl"><fmt:message key="Abbreviation"/></td>
<td><input type="text" name="wineLevel.abbreviation" size="3" maxlength="3"/><font class="fm">*</font></td>
</tr>

<tr>
<td class="tl"><fmt:message key="Definition"/></td>
<td><input type="text" name="wineLevel.definition"/><font class="fm">*</font></td>
</tr>
</tbody>
