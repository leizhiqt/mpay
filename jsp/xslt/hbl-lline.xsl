...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
 ...
 <fo:layout-master-set>
    <fo:simple-page-master master-name="all"
			page-width="260mm" page-height="337mm"
        	margin-top="4mm" margin-bottom="5.5mm"
        	margin-left="4mm" margin-right="0mm">
        ...
        <!--left-table-->
            <fo:table>
             ...
             <fo:table-body>
	                ...
	                <fo:table-cell text-align="right" 
                         ...
                         padding-before="8mm" padding-after="0pt"
                         padding-start="4mm" padding-end="0pt">
             ...
             <fo:table-row>
                 ...
                 <fo:table>
                   ...
                   <fo:table-row height="9mm">
	                	...
	                	<fo:table-cell text-align="right" 
                         border-color="black" border-width="1pt" border-style="none"
                         padding-before="4mm" padding-after="0pt"
                         padding-start="4mm" padding-end="0pt">
		  ...
		  <fo:table-cell border-width="1pt"  padding-left="0.00mm">
		     ...
		     <fo:table>
		      ...
		      <fo:table-body>
					<!-- log text -->
                       <fo:table-row height="95mm"></fo:table-row>
					<!--  right start row -->
                       <fo:table-row height="9mm">
				 					<fo:table-cell border-color="black" border-width="1pt" border-style="none"
														padding-before="4mm" padding-after="0pt" padding-start="4mm" padding-end="0pt">
...
<!-- end  -->
                ...
                <!--MIDDLE TABLE-->
                       <fo:table-row height="4mm"></fo:table-row>
					...
					<!--  start -->
                      ...
                      <fo:table-cell>
                       ...
                       <fo:table padding-before="0.0mm">
		      				...
		      				<fo:table-column column-width="55mm"/>
		     	 	   <fo:table-body>
                    	<fo:table-row height="6mm"> </fo:table-row>
                  
                    <fo:table-row height="92mm">
						<!-- FreightMark -->
	              	<fo:table-cell text-align="right" 
                         border-color="black" border-width="1pt" border-style="none"
                         padding-before="7mm" padding-after="0pt"
                         padding-start="4mm" padding-end="0pt">
...
<xsl:for-each select="Lookup">
				...
				<xsl:for-each select="FreightMessage">
                        ...
                        <fo:table-cell text-align="right" 
                         ...
                         padding-start="4mm" padding-end="0pt">
		     					...
		     					<fo:table>
		      					...
		      					<fo:table-body>
									<!-- log text -->
                       		<fo:table-row height="20mm" border-style="none">
                        <fo:table-cell text-align="right" 
                       ...
                       <fo:table-row height="30mm"></fo:table-row>
                       ...
                       <fo:table-row>
						...
						<fo:table>
		      							...
		      							<fo:table-column column-width="121mm"/>
				...
				<fo:table-cell border-color="black" border-width="0pt" border-style="none" number-columns-spanned="2"
					padding-before="0pt" padding-after="0pt" padding-start="4mm" padding-end="0pt">
				</fo:table-cell>
                       </fo:table-row>
            </fo:table-body> 
           </fo:table>
