...
<fo:page-sequence master-reference="simpleA4">
	...
	<fo:flow flow-name="xsl-region-body">
		...
		<fo:block font-size="12pt" text-align="center" space-after="2mm">
			前 言
		</fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row>
					<fo:table-cell  border="1pt solid black"  number-columns-spanned="2" >
					   ...
					   <fo:block font-size="8pt" space-after="2mm" space-before="1mm">否则应当向其他各方分别支付产品价款总额20%的违约金：</fo:block>
		<fo:table>
			...
			<fo:table-body>
				<fo:table-row>
					<fo:table-cell  border="1pt solid black"  >
						<fo:block font-size="8pt"  space-before="1mm" space-after="1mm">
						姓名
						</fo:block>
					</fo:table-cell>
					<fo:table-cell  border="1pt solid black" >
		...
		<!-- will handle footer later <xsl:apply-templates select="footer"/> -->
						...
						<fo:block font-size="8pt" space-before="2mm" >3、
							违约方承担诉讼费、差旅费和律师费。
						</fo:block>
						<fo:block font-size="8pt"  space-before="1mm">
							4.1消费者签署本合同即表明不可撤销地授权___________________银行代为从其在《还款指引》上指定的还款账户
							</fo:block>
							<fo:block font-size="8pt" text-indent="0.4in" space-before="1mm">
							（账号： ____________________开户行：_____________________）中按月代扣当月应付销售方、担保方以及服务提供方相应款项。
							</fo:block>
						

						<fo:block font-size="8pt" text-indent="0.2in" space-before="1mm">
						...
						<fo:block font-size="8pt" font-weight="bold" text-align="center" space-before="2mm" >
							专用条款一：分期付款买卖条款
						</fo:block>
			...
			<fo:table-body>
				...
				<fo:table-row height="2cm">
					...
					<fo:table-cell  border="1pt solid black" >
						...
						<fo:block font-size="8pt" space-before="1mm"  >
							8、 本产品质保期以质保书为准。在质保期内如消费者所购产品出现产品本身质量问题的，由_____________（门店）负责维修、更换。
						</fo:block >
						<fo:block font-size="8pt" space-before="1mm"  >
							9、 违约责任
						</fo:block>
						<fo:block font-size="8pt" space-before="1mm" text-indent="0.2in" >
						...
						<fo:block font-size="8pt" space-before="1mm">
							...
							<fo:block text-indent="0.2in" font-size="8pt" space-before="1mm">
							2.1 协助消费者办理分期付款消费与担保申请手续，包括制作各种申请文件、搜集整理相关信息资料，代为保管本合
							</fo:block >
							<fo:block text-indent="0.4in" font-size="8pt" space-before="1mm">
							同和消费者签署的申请表的正本等相关资料
							</fo:block>
							<fo:block text-indent="0.2in" font-size="8pt" space-before="1mm">
							...
							<fo:block font-size="8pt" space-before="1mm">
							3、 消费者接受前述服务应向服务提供方支付服务费，服务费总金额为     元按月分期支付，共分    期（以《还款指引》为准）。
							</fo:block>
							<fo:block font-size="8pt" space-before="1mm">
						...
						<fo:block font-size="8pt" space-before="1mm">
							...
							<fo:block font-size="8pt" space-before="1mm">
							4、 消费者接受前述担保服务应向担保方支付担保费，服务费总金额为________元按月分期支付，共分______期（以《还款指引》为准）。
							</fo:block>
							<fo:block font-size="8pt" space-before="1mm">
