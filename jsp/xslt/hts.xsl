...
<fo:page-sequence master-reference="simpleA4">
	...
	<fo:flow flow-name="xsl-region-body">
			...
			<fo:table-body>
				...
				<fo:table-row>
					<fo:table-cell  border="1pt solid black"  number-columns-spanned="2" >
						...
						<fo:block font-size="7pt" font-weight="bold" text-align="center">通用条款</fo:block>
					   ...
					   <fo:block font-size="7pt"     >否则应当向其他各方分别支付产品价款总额20%的违约金：</fo:block>
		<fo:table>
		...
		<!-- will handle footer later <xsl:apply-templates select="footer"/> -->
						...
						<fo:block font-size="7pt" font-weight="bold" text-align="center" space-before="2mm" >
							专用条款一：分期付款买卖条款
						</fo:block>
