...
CREATE TABLE `Product` (
  ...
  CONSTRAINT `Product_ibfk_2` FOREIGN KEY (`weightUnitId`) REFERENCES `wineShared`.`Unit` (`id`),
  CONSTRAINT `Product_ibfk_3` FOREIGN KEY (`volumeUnitId`) REFERENCES `wineShared`.`Unit` (`id`),
  CONSTRAINT `Product_ibfk_4` FOREIGN KEY (`costCurrId`) REFERENCES `wineShared`.`Currency` (`id`),
  CONSTRAINT `Product_ibfk_5` FOREIGN KEY (`memberCurrId`) REFERENCES `wineShared`.`Currency` (`id`),
  CONSTRAINT `Product_ibfk_6` FOREIGN KEY (`retailCurrId`) REFERENCES `wineShared`.`Currency` (`id`)
